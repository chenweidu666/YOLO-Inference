...
def main():
    # Load models
    fp32_session = ort.InferenceSession("../01-models/yolov5su_fp32.onnx", providers=['CPUExecutionProvider'])
    int8_session = ort.InferenceSession("../01-models/yolov5su_int8.onnx", providers=['CPUExecutionProvider'])
